...
import com.pinguela.rentexpres.desktop.renderer.RentalActionsCellEditor;
import com.pinguela.rentexpres.desktop.renderer.RentalActionsCellRenderer;
...
public class RentalTablePanel extends JPanel {
	...
	public RentalTablePanel(Frame owner, RentalService service) {
		this.owner = owner;
	...
	public void setModel(RentalSearchTableModel model) {
		...
		table.getColumn("Acciones").setCellRenderer(new RentalActionsCellRenderer());
		table.getColumn("Acciones").setCellEditor(new RentalActionsCellEditor(owner, service, this));
	...
	public RentalDTO getSelected() {
		int r = table.getSelectedRow();
		return r < 0 ? null : ((RentalSearchTableModel) table.getModel()).getRentalAt(r);
	}
