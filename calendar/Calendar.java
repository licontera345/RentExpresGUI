...
public abstract class Calendar extends JComponent {
    ...
    private void fireCalendarEventClick(CalendarEvent calendarEvent) {
        ...
        // because Swing EventListenerList stores listeners in an array where each
        // listener class type is followed by the actual listener instance. the structure of
        // listenerList.getListenerList() is:
        // [ListenerType1, ListenerInstance1, ListenerType2, ListenerInstance2, ...]
        // odd index (from the end) stores the listener TYPE
        // even index (next one) stores the actual listener INSTANCE
